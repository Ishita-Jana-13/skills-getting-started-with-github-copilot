...
activities = {
    ...
    "Robotics Club": {
        ...
        "max_participants": 25,
        "participants": ["chris@mergington.edu", "laura@mergington.edu"]
    },
    "Art Studio": {
    ...
    "Music Band": {
        "description": "Learn and perform music in a school band ensemble",
        "schedule": "Mondays, Wednesdays, Fridays, 3:30 PM - 4:30 PM",
        "max_participants": 35,
        "participants": ["noah@mergington.edu", "ava@mergington.edu"]
    },
    "Theater Club": {
        "description": "Participate in dramatic plays and theatrical performances",
